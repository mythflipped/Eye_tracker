            ...
            if right_eye_frame is not None:
                if self.rightEyeCheckbox.isChecked():
                    ...
                    if right_keypoints is not None:
                        print('right key point')
                        for kp in right_keypoints:
                            print(kp.pt)
                    if right_eye_estimated_position is not None:
                        print('right eye estimated position')
                        print(right_eye_estimated_position)
                    # if right_keypoints is not None:
                    #     print("kp:"+right_keypoints)
                    # if right_eye_estimated_position is not None:
                    #     print("estp"+right_eye_estimated_position)
