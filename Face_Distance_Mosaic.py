...
def define_img_size(image_size):
    ...
    for size in image_size:
        feature_map = [int(ceil(size / stride)) for stride in strides]  # 图片不失真
...
#                 print(focalLength)
                distance = distance_to_camera(15,580, pix_person_height)
                ...
                if distance/100>1.0:
                    ...
                    cv2.putText(img_ori, "%.2fcm" % (distance),
                     ...
                     1, (255,0 , 255), 2)
#                 人脸马赛克
                do_mosaic(img_ori, box[0]+5, box[1]+5, box[2]-box[0]-5, box[3]-box[1]-5, neighbor=9)
